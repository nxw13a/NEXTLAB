...
<div class="content" style="background-color: #3b0066; border-radius: 10px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); ">
    <h2 style="color: orange; text-align: center;">The NEXT's Updates </h2>
    <h3 style="color: lightgreen; text-align: left;">2017</h3>
    <hr style="margin-top: -10px; margin-bottom: 10px;"/>
        <h4 style="color: white; "><a href="MSTL" style="color: aqua;">Status of Molten Salt Test Loop (MSTL) Assembly and Testing by Rich Jinkerson</a></h4>
    <p style="color: GrayText; margin-left: 30px;"><i>In early February of this year Rusty Towell and Rich Jinkerson were presented with an opportunity to accelerate the progress of NEXT-sponsored molten salt research . . . (September 13, 2017)</i></p>
        <h4 style="color: white; "><a href="Characteristic" style="color: aqua;">Characterization of Salt Mixtures by Aaron Robison</a></h4>
    ...
    <h4 style="color: white; "><a href="Instrumentation" style="color: aqua;">Instrumentation by Tim Head</a></h4>
