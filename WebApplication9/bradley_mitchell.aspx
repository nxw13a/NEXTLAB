<%@ Page Title="Bradley Mitchell" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="bradley_mitchell.aspx.cs" Inherits="WebApplication9.bradley_mitchell" %>
...
@media screen and (max-width: 750px) {
  ...
  <h1 style="color: white; text-align: center; padding: 5px; background-color:rgb(98,99,102); border-radius: 10px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">Student</h1>
<div class="row">
<div class="column1">
<ul class="sidenav">
...
<div class="content" style="background-color: rgb(225,225,225); border-radius: 10px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); ">
     <h2 style="color: rgb(98,99,102); font-weight: bold; text-align: center; ">Bradley Mitchell </h2>
     <div style="margin-bottom: 10px;"><img src="brad_m.png" style="display: block; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); max-width:100%; max-height:100%; margin: 0 auto;"/></div>

        <div id="intro" style="text-align: center;">
             <p >
                <i>Senior Engineering student</i>
             </p>
             <p>
                 Email: <a style="color: rgb(123,164,221); font-weight: bold;" href="mailto:bam13e@acu.edu">bam13e@acu.edu</a>
             </p>
          </div>

        <p>
            <i>I am a senior Engineering student with responsibilities of modeling and design. My areas of expertise are Matlab, CAD and 3D printing. My mission is to help our world gain access to clean energy.</i>
        </p>
</div>
</div>
</div>
