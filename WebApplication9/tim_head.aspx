...
<div class="content" style="background-color: #3b0066; border-radius: 10px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); ">
     <h2 style="color: orange; text-align: center; ">Dr. Tim Head</h2>
    ...
    <div id="topcontent" style="color: white;"">
        <div id="intro">
             ...
             <p>
                 Email: <a style="color: aqua;" href="mailto:tlh07b@acu.edu ">tlh07b@acu.edu </a>
             </p>
          </div>
        ...
        <h3 style="color: orange;">Campus Service: </h3>
        <p>
