...
@media screen and (max-width: 1199px) and (min-width: 991.9px) {
    ...
    div.content {margin-top: -904px; height: 400px;}
    #sideCOL{
        width: 240px;
    }
    #textcolumn{
...
<div class="content" style="background-color: #3b0066; border-radius: 10px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); ">
     <h2 style="color: orange; text-align: center; ">Dr. Kim Pamplin </h2>
     <div id="imgcolumn""><img src="kim_p.png" style="display: block; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); max-width:100%; max-height:100%; margin: 0 auto;"/></div>
    ...
    <div id="topcontent" style="color: white;"">
        <div id="intro">
             <p >
                <i>Associate Professor of Department of Chemistry and Biochemistry.</i>
             </p>
             <p>
                 Email: <a style="color: aqua;" href="mailto:pamplink@acu.edu">pamplink@acu.edu</a>
             </p>
          </div>
        ...
        <p>
          ...
          <h3 style="color: orange;">Goals at NEXT: </h3>
        <p>
