...
<div class="content" style="background-color: #3b0066; border-radius: 10px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); ">
    <h2 style="color: orange; text-align: center;">Related Sites</h2>
    <h4 style="color: white; "><a href="https://ec.europa.eu/jrc/en/news/prostate-cancer-alpha-therapy-shows-impressive-results" style="color: aqua;" target="_blank">Hope for metastatic prostate cancer patients: targeted alpha therapy shows impressive results</a></h4>
